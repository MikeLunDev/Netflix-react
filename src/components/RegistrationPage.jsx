...
import { FormGroup, Label, Tooltip, Spinner, Alert } from "reactstrap";
...
export default class RegistrationPage extends Component {
  ...
  handleRegistration = async values => {
    try {
      var resp = await fetch("http://localhost:3055/user/register", {
        method: "POST",
      ...
      } else this.setState({ errMess: resp.messages, isLoading: false });
    } catch (err) {
      console.log(err);
                ...
                <FormGroup>
                  ...
                  <Errors
                    ...
                    messages={{
                      ...
                      maxAgeValidator:
                        "Do you really have more than 110 years?",
                      requiredValidator: "Required!"
                    }}
                  />
                </FormGroup>
